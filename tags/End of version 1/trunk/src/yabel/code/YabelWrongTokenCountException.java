...
public class YabelWrongTokenCountException extends YabelException {
    ...
    /**
     * The input contained the wrong number of arguments when there were two
     * possibilities
     * 
     * @param toks
     *            Compiler input tokens
    ...
    public YabelWrongTokenCountException(List<String> toks, int reqSize1,
        ...
        super(
                MessageFormat.format(
                        ...
                        toks.get(1).toUpperCase(), Integer.valueOf(reqSize1),
                        desc1, Integer.valueOf(reqSize2), desc2,
                        Integer.valueOf(toks.size()), toks.get(0)));
    }


    /**
     * The input contained the wrong number of arguments when there were three
     * possibilities
     * 
     * @param toks
     *            Compiler input tokens
    ...
    /**
     * The input contained the wrong number of arguments when there were many
     * possibilities
     * 
     * @param toks
     *            Compiler input tokens
