...
public class ClassBuilder {
    ...
    protected ConstantPool cp_ = new ConstantPool();

    /** Fields for this class */
    protected List<Field> fields_ = new ArrayList<Field>();

    /** Interfaces for this class */
    protected List<ConstantClass> interfaces_ = new ArrayList<ConstantClass>();
    ...
    /** This class */
    final ConstantClass thisClass_;
    ...
    public Method getMethod(String name, String type) {
        ...
        for(Method m:methods_) {
            if( (nameId == m.name_) && (typeId == m.type_) ) return m;
        }
        return null;
    }
    ...
    public String getName() {
        int id = thisClass_.get();
        ConstantUtf8 co = cp_.validate(id, ConstantUtf8.class);
        return co.get();
    }
